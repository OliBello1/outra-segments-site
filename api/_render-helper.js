...
+ '<style>\n'
+ '.oev-seg{background:linear-gradient(170deg,#0A135B 0%,#13206E 55%,#1A2380 100%);color:#fff;padding:34px 24px 38px;position:relative;overflow:hidden;}\n'
...
+ '.oev-card{background:rgba(255,255,255,0.045);border:1px solid rgba(255,255,255,0.10);border-radius:16px;backdrop-filter:blur(6px);padding:14px 18px;margin-bottom:14px;}\n'
...
+ '.oev-table tbody td{padding:6px 12px;border-bottom:1px solid rgba(255,255,255,0.06);vertical-align:middle;}\n'
...
+ '@media(max-width:760px){.oev-table thead th.oev-th-crit,.oev-table td.oev-seg-crit{display:none;}.oev-seg{padding:40px 16px 46px;}}\n'
+ '</style>\n'
