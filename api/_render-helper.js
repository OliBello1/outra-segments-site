...
function buildCommercialsHtml(record) {
  ...
  function buildSliderStack(opp) {
    ...
    const sliderCard = ''
      ...
      +     '<span class="prop-slider-sites-label">matched records / month</span>'
      +   '</div>'
  ...
  function buildLoafCompactCss() {
    return '\n<style>\n'
      ...
      + '.prop-commercials:has(.loaf-cp){padding-top:20px;padding-bottom:22px;}\n'
      + '.loaf-cp .prop-commercials-header{margin-bottom:12px;text-align:center;}\n'
      + '.loaf-cp .prop-commercials-title{font-size:24px;margin-bottom:4px;}\n'
      ...
      + '.loaf-cp .prop-pricing-card{padding:14px 20px;}\n'
      + '.loaf-cp .prop-pricing-card-name{margin-bottom:3px;font-size:13px;}\n'
      + '.loaf-cp .prop-pricing-card-headline{margin-bottom:8px;font-size:13px;}\n'
      + '.loaf-cp .prop-refresh-pill{margin:0 0 8px;}\n'
      + '.loaf-cp .prop-slider-wrap{margin:4px 0 8px;}\n'
      + '.loaf-cp .prop-slider-sites-num{font-size:32px;line-height:1.05;}\n'
      ...
      + '.loaf-cp .unlimited-price{font-size:34px;line-height:1.05;margin-bottom:3px;}\n'
      ...
      + '.loaf-cp .prop-commercials-footnote{margin-top:5px;font-size:11px;}\n'
