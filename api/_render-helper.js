...
+ '<style>\n'
+ '.oev-seg{background:linear-gradient(170deg,#0A135B 0%,#13206E 55%,#1A2380 100%);color:#fff;padding:64px 24px 72px;position:relative;overflow:hidden;}\n'
...
+ '.oev-eyebrow{display:inline-block;font-size:11.5px;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:#9FAAFF;background:rgba(159,170,255,0.12);border:1px solid rgba(159,170,255,0.28);padding:4px 13px;border-radius:999px;margin-bottom:10px;}\n'
...
+ '.oev-card{background:#F6F5F1;border:1px solid #E8E5DF;border-radius:16px;padding:18px 20px;margin-bottom:14px;box-shadow:0 2px 8px rgba(0,0,0,0.06);}\n'
+ '.oev-card-title{display:flex;align-items:center;gap:10px;font-size:12px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#0A135B;margin:0 0 9px;}\n'
...
+ '.oev-table thead th{text-align:left;font-size:10.5px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:rgba(10,19,91,0.45);padding:0 12px 8px;border-bottom:1px solid rgba(10,19,91,0.10);}\n'
...
+ '.oev-seg-brief{color:rgba(10,19,91,0.60);}\n'
...
+ '.oev-uprn-pct{display:inline-block;color:rgba(10,19,91,0.42);font-size:11px;margin-left:6px;min-width:42px;}\n'
+ '.oev-seg-crit{color:rgba(10,19,91,0.50);font-size:12px;}\n'
...
+ '.oev-pill{display:flex;align-items:center;gap:10px;padding:8px 12px;border-radius:10px;background:#fff;border:1px solid #E8E5DF;box-shadow:0 1px 4px rgba(0,0,0,0.06);margin-bottom:6px;flex:1 1 0;min-height:0;}\n'
...
+ '.oev-pill-desc{font-size:10.5px;color:rgba(10,19,91,0.62);line-height:1.3;}\n'
