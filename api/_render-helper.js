...
+ '<style>\n'
+ '.oev-seg{background:linear-gradient(170deg,#0A135B 0%,#13206E 55%,#1A2380 100%);color:#fff;padding:48px 24px 56px;position:relative;overflow:hidden;}\n'
...
+ '.oev-card{background:#F6F5F1;border:1px solid #E8E5DF;border-radius:16px;padding:14px 16px;margin-bottom:14px;box-shadow:0 2px 8px rgba(0,0,0,0.06);}\n'
