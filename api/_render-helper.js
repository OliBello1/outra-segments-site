...
+ '<style>\n'
+ '.oev-seg{background:linear-gradient(170deg,#0A135B 0%,#13206E 55%,#1A2380 100%);color:#fff;padding:44px 24px 48px;position:relative;overflow:hidden;}\n'
...
+ '.oev-head{text-align:center;margin-bottom:16px;}\n'
...
+ '.oev-title{font-size:clamp(24px,3vw,30px);font-weight:800;line-height:1.1;margin:0 0 5px;letter-spacing:-0.02em;}\n'
...
+ '.oev-card{background:#F6F5F1;border:1px solid #E8E5DF;border-radius:14px;padding:14px 16px;margin-bottom:10px;box-shadow:0 2px 8px rgba(0,0,0,0.06);}\n'
+ '.oev-card-title{display:flex;align-items:center;gap:10px;font-size:11px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#0A135B;margin:0 0 6px;}\n'
...
+ '.oev-table thead th{text-align:left;font-size:10px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:rgba(10,19,91,0.45);padding:0 10px 5px;border-bottom:1px solid rgba(10,19,91,0.10);}\n'
+ '.oev-table thead th.oev-th-uprn{text-align:right;}\n'
+ '.oev-table tbody td{padding:5px 10px;border-bottom:1px solid rgba(10,19,91,0.06);vertical-align:middle;}\n'
...
+ '.oev-body{display:grid;grid-template-columns:1.55fr 1fr;gap:14px;align-items:stretch;}\n'
...
+ '.oev-split{display:grid;grid-template-columns:1fr;grid-template-rows:6fr 4fr;gap:12px;height:100%;}\n'
+ '.oev-split .oev-card{margin-bottom:0;display:flex;flex-direction:column;min-height:0;}\n'
+ '.oev-split .oev-card-title{flex:0 0 auto;}\n'
+ '.oev-pill{display:flex;align-items:center;gap:10px;padding:6px 11px;border-radius:10px;background:#fff;border:1px solid #E8E5DF;box-shadow:0 1px 4px rgba(0,0,0,0.06);margin-bottom:5px;flex:1 1 0;min-height:0;}\n'
