...
+ '<style>\n'
+ '.oev-seg{background:linear-gradient(170deg,#0A135B 0%,#13206E 55%,#1A2380 100%);color:#fff;padding:16px 24px 16px;position:relative;overflow:hidden;min-height:100vh;display:flex;align-items:stretch;box-sizing:border-box;}\n'
...
+ '.oev-card-title{display:flex;align-items:center;gap:10px;font-size:12px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#0A135B;margin:0 0 8px;}\n'
...
+ '.oev-body{display:grid;grid-template-columns:1.7fr 1fr;gap:18px;align-items:stretch;flex:1 1 auto;}\n'
...
+ '.oev-split{display:grid;grid-template-columns:1fr;grid-template-rows:6fr 4fr;gap:16px;height:100%;}\n'
+ '.oev-split .oev-card{margin-bottom:0;display:flex;flex-direction:column;min-height:0;}\n'
+ '.oev-split .oev-card-title{flex:0 0 auto;}\n'
+ '.oev-pill{display:flex;align-items:center;gap:10px;padding:7px 12px;border-radius:10px;background:#fff;border:1px solid #E8E5DF;box-shadow:0 1px 4px rgba(0,0,0,0.06);margin-bottom:6px;flex:1 1 0;min-height:0;}\n'
