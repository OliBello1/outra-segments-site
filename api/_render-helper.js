...
function buildCommercialsHtml(record) {
  ...
  function buildLoafCompactCss() {
    return '\n<style>\n'
      ...
      + '.prop-commercials:has(.loaf-cp){padding-top:16px;padding-bottom:18px;}\n'
      + '.loaf-cp .prop-commercials-header{margin-bottom:10px;text-align:center;}\n'
      + '.loaf-cp .prop-commercials-title{font-size:22px;margin-bottom:3px;}\n'
      ...
      + '.loaf-cp .prop-pricing-card-name{margin-bottom:2px;font-size:12px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}\n'
      + '.loaf-cp .prop-pricing-card-headline{margin-bottom:6px;font-size:12px;}\n'
      + '.loaf-cp .prop-refresh-pill{margin:0 0 6px;}\n'
      + '.loaf-cp .prop-slider-wrap{margin:3px 0 6px;}\n'
      + '.loaf-cp .prop-slider-sites-num{font-size:28px;line-height:1.05;}\n'
      + '.loaf-cp .prop-slider-sites-label{font-size:11px;}\n'
      + '.loaf-cp .prop-price-display{margin:3px 0 2px;}\n'
      + '.loaf-cp .prop-price-num{font-size:24px;}\n'
      + '.loaf-cp .prop-price-meta{margin-bottom:4px;font-size:11px;}\n'
      + '.loaf-cp .prop-tier-table{margin-top:3px;}\n'
      + '.loaf-cp .prop-tier-row{padding:1px 0;font-size:11.5px;}\n'
      + '.loaf-cp .unlimited-price{font-size:28px;line-height:1.05;margin-bottom:2px;}\n'
      + '.loaf-cp .unlimited-period{margin-bottom:6px;font-size:11.5px;}\n'
      + '.loaf-cp .unlimited-features{margin-top:3px;}\n'
      + '.loaf-cp .unlimited-features li{margin-bottom:3px;font-size:12px;}\n'
      + '.loaf-cp .prop-commercials-footnote{margin-top:4px;font-size:10.5px;}\n'
      ...
      + '.loaf-cp .loaf-bonus-tag{display:inline-block;margin-bottom:5px;padding:2px 9px;border-radius:999px;font-size:10px;font-weight:800;letter-spacing:0.5px;text-transform:uppercase;background:rgba(77,203,199,1);color:#06201f;}\n'
      + '.loaf-cp .loaf-bonus-title{font-size:14px;font-weight:800;color:#fff;margin-bottom:1px;}\n'
      + '.loaf-cp .loaf-bonus-sub{font-size:11.5px;color:rgba(255,255,255,0.7);margin-bottom:6px;}\n'
