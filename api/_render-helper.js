...
function buildCommercialsHtml(record) {
  ...
  function buildLoafCompactCss() {
    return '\n<style>\n'
      ...
      + '.prop-commercials:has(.loaf-cp){min-height:100vh;box-sizing:border-box;display:flex;flex-direction:column;justify-content:center;padding-top:48px;padding-bottom:48px;}\n'
      + '.loaf-cp .prop-commercials-header{margin-bottom:32px;text-align:center;}\n'
      + '.loaf-cp .prop-commercials-title{font-size:36px;margin-bottom:8px;}\n'
      + '.loaf-cp .prop-commercials-sub{max-width:760px;margin-left:auto;margin-right:auto;font-size:17px;}\n'
      ...
      + '.loaf-cp .prop-pricing-card{padding:17px 24px;}\n'
      + '.loaf-cp .prop-pricing-card-name{margin-bottom:6px;font-size:18px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}\n'
      + '.loaf-cp .prop-refresh-pill{margin:0 0 6px;}\n'
      + '.loaf-cp .prop-slider-wrap{margin:5px 0 6px;}\n'
      + '.loaf-cp .prop-slider-sites-num{font-size:30px;line-height:1.1;}\n'
      + '.loaf-cp .prop-slider-sites-label{font-size:16px;}\n'
      + '.loaf-cp .prop-slider-ticks{font-size:14px;}\n'
      + '.loaf-cp .prop-price-display{margin:5px 0 3px;}\n'
      + '.loaf-cp .prop-price-num{font-size:28px;}\n'
      + '.loaf-cp .prop-price-meta{margin-bottom:5px;font-size:16px;min-height:0;}\n'
      + '.loaf-cp .prop-tier-table{margin-top:5px;}\n'
      // Revealed volume-pricing breakdown (opt-in via slider.show_tiers).
      + '.loaf-cp .loaf-tier-heading{margin-top:8px;font-size:14px;font-weight:700;letter-spacing:0.3px;text-transform:uppercase;color:rgba(255,255,255,0.45);}\n'
      + '.loaf-cp .prop-tier-table.loaf-tier-show{display:block;border-top:1px solid rgba(255,255,255,0.12);padding-top:6px;margin-top:5px;}\n'
      ...
      + '.loaf-cp .prop-tier-row{padding:2px 0;font-size:16px;}\n'
      + '.loaf-cp .unlimited-price{font-size:39px;line-height:1.1;margin-bottom:5px;}\n'
      + '.loaf-cp .unlimited-period{margin-bottom:18px;font-size:18px;}\n'
      + '.loaf-cp .unlimited-features{margin-top:14px;}\n'
      + '.loaf-cp .unlimited-features li{margin-bottom:5px;font-size:19px;}\n'
      + '.loaf-cp .prop-commercials-footnote{margin-top:24px;font-size:15px;}\n'
      ...
      + '.loaf-cp .prop-card-channels-label{font-size:14px;font-weight:700;letter-spacing:0.3px;text-transform:uppercase;color:rgba(255,255,255,0.45);margin-bottom:6px;}\n'
      + '.loaf-cp .prop-card-channels-light .prop-card-channels-label{color:rgba(255,255,255,0.65);}\n'
      + '.loaf-cp .prop-card-channels-logos{display:flex;flex-wrap:nowrap;gap:9px;align-items:center;}\n'
      ...
      + '.loaf-cp .loaf-bonus{margin-top:12px;padding:14px 20px;border-radius:10px;background:rgba(77,203,199,0.10);border:1px solid rgba(77,203,199,0.45);}\n'
      + '.loaf-cp .loaf-bonus-tag{display:inline-block;margin-bottom:9px;padding:6px 14px;border-radius:999px;font-size:14px;font-weight:800;letter-spacing:0.2px;text-transform:uppercase;background:rgba(77,203,199,1);color:#06201f;}\n'
      + '.loaf-cp .loaf-bonus-title{font-size:18px;font-weight:800;color:#fff;margin-bottom:3px;}\n'
      + '.loaf-cp .loaf-bonus-sub{font-size:16px;color:rgba(255,255,255,0.7);margin-bottom:7px;}\n'
      + '.loaf-cp .loaf-bonus-list{list-style:none;margin:0;padding:0;}\n'
      + '.loaf-cp .loaf-bonus-list li{position:relative;padding-left:26px;margin-bottom:7px;font-size:17px;line-height:1.25;color:rgba(255,255,255,0.92);}\n'
      + '.loaf-cp .loaf-bonus-list li:last-child{margin-bottom:0;}\n'
      + '.loaf-cp .loaf-bonus-list li::before{content:"\\2713";position:absolute;left:0;top:0;color:rgba(77,203,199,1);font-weight:800;font-size:18px;}\n'
      + '</style>\n';
  }
  ...
  function buildLoafSliderScript() {
    return '\n<script>(function(){\n'
      ...
      + '  var capNote=document.getElementById(prefix+"CapNote"); if(capNote) capNote.textContent=saving>0?"Unlimited tier saves you "+gbp(saving)+"/mo \\u2014 switch to "+gbp(cap)+"/mo flat.":"";\n'
...
+ '.oev-table tbody td{padding:10px 12px;border-bottom:1px solid rgba(10,19,91,0.06);vertical-align:middle;}\n'
+ '.oev-table tbody tr:last-child td{border-bottom:none;}\n'
+ '.oev-seg-name{font-weight:700;color:#0A135B;white-space:nowrap;}\n'
+ '.oev-seg-brief{color:rgba(10,19,91,0.85);}\n'
...
+ '.oev-uprn-pct{display:inline-block;color:rgba(10,19,91,0.72);font-size:11px;margin-left:6px;min-width:42px;}\n'
+ '.oev-seg-crit{color:rgba(10,19,91,0.80);font-size:12px;}\n'
...
+ '.oev-pill-label{font-weight:700;font-size:10px;color:#0A135B;}\n'
+ '.oev-pill-desc{font-size:9px;color:rgba(10,19,91,0.85);line-height:1.3;}\n'
...
+           '<th class="oev-th-uprn">UPRN<span style="font-size:0.75em">s</span></th><th class="oev-th-crit">Key criteria</th>'
+           '</tr></thead>\n'
...
function buildOctopusEvProposalCommercialsSection() {
  ...
  // Small monochrome header chips (kept deliberately restrained/navy rather
  // than "rainbow" per-column colors) — differentiation between plans comes
  // from the hero treatment on the anchor column, not chip color.
  const OEVP_CHIP_ICONS = {
    platform: '<svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="4.2" rx="1.4"/><rect x="4" y="9.9" width="16" height="4.2" rx="1.4"/><rect x="4" y="15.8" width="16" height="4.2" rx="1.4"/></svg>',
    trial: '<svg viewBox="0 0 24 24" fill="#fff"><polygon points="13,2 4,14 11,14 9,22 20,9 12,9"/></svg>',
    scale: '<svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3,17 9,11 13,15 21,6"/><polyline points="15,6 21,6 21,12"/></svg>'
  };
  ...
  const columns = [
    {
      ...
      bullets: [
        { label: 'Off-the-shelf platform audiences', detail: 'Delivered into:', channels: [
...
+ '<style>\n'
+ '.oevp-seg{background:linear-gradient(170deg,#0A135B 0%,#13206E 55%,#1A2380 100%);color:#fff;padding:22px 24px;position:relative;z-index:2;isolation:isolate;overflow:hidden;height:100vh;display:flex;align-items:center;box-sizing:border-box;}\n'
...
+ '.oevp-card-toprow{display:flex;align-items:center;gap:8px;margin-bottom:5px;}\n'
+ '.oevp-chip{flex:0 0 auto;width:30px;height:30px;border-radius:9px;background:rgba(255,255,255,0.10);border:1px solid rgba(255,255,255,0.16);display:flex;align-items:center;justify-content:center;}\n'
+ '.oevp-chip svg{width:16px;height:16px;display:block;}\n'
+ '.oevp-card-title{font-size:14px;font-weight:800;color:#fff;margin:0;letter-spacing:-0.01em;}\n'
+ '.oevp-card-sub{font-size:10px;font-weight:600;color:rgba(255,255,255,0.60);margin:0;text-transform:uppercase;letter-spacing:.03em;}\n'
+ '.oevp-card-desc{font-size:10px;line-height:1.3;color:rgba(255,255,255,0.75);margin:12px 0 0;}\n'
+ '.oevp-card-desc strong{color:#fff;font-weight:700;}\n'
+ '.oevp-stat-list{list-style:none;margin:8px 0 0;padding:0;display:flex;flex-direction:column;gap:2px;}\n'
...
+ '.oevp-list-heading{margin:12px 0 6px;font-size:9.5px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:rgba(255,255,255,0.55);}\n'
...
+ '.oevp-price-row{margin-top:10px;padding:9px 10px;border-radius:12px;background:rgba(255,255,255,0.08);display:flex;align-items:baseline;justify-content:space-between;gap:6px;flex:0 0 auto;}\n'
+ '.oevp-card-hero .oevp-price-row{background:linear-gradient(135deg,rgba(194,254,151,0.22),rgba(76,220,199,0.22));}\n'
+ '.oevp-price-label{font-size:9px;font-weight:600;color:rgba(255,255,255,0.65);text-transform:uppercase;letter-spacing:.02em;white-space:nowrap;}\n'
