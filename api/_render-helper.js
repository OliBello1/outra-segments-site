...
+ '<style>\n'
+ '.oev-seg{background:linear-gradient(170deg,#0A135B 0%,#13206E 55%,#1A2380 100%);color:#fff;padding:20px 24px 14px;position:relative;overflow:hidden;height:100vh;display:flex;align-items:center;box-sizing:border-box;}\n'
...
+ '.oev-head{text-align:center;margin-bottom:14px;}\n'
...
+ '.oev-card{background:#F6F5F1;border:1px solid #E8E5DF;border-radius:16px;padding:15px 17px;margin-bottom:10px;box-shadow:0 2px 8px rgba(0,0,0,0.06);}\n'
...
+ '.oev-table tbody td{padding:8px 12px;border-bottom:1px solid rgba(10,19,91,0.06);vertical-align:middle;}\n'
...
+ '.oev-pill{display:flex;align-items:center;gap:10px;padding:6px 12px;border-radius:10px;background:#fff;border:1px solid #E8E5DF;box-shadow:0 1px 4px rgba(0,0,0,0.06);margin-bottom:5px;flex:1 1 0;min-height:0;}\n'
