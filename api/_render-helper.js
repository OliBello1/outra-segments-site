...
+ '<style>\n'
+ '.oev-seg{background:linear-gradient(170deg,#0A135B 0%,#13206E 55%,#1A2380 100%);color:#fff;padding:36px 24px 40px;position:relative;overflow:hidden;}\n'
...
+ '.oev-head{text-align:center;margin-bottom:12px;}\n'
...
+ '.oev-title{font-size:clamp(22px,2.8vw,28px);font-weight:800;line-height:1.05;margin:0 0 4px;letter-spacing:-0.02em;}\n'
...
+ '.oev-card{background:#F6F5F1;border:1px solid #E8E5DF;border-radius:14px;padding:12px 14px;margin-bottom:10px;box-shadow:0 2px 8px rgba(0,0,0,0.06);}\n'
+ '.oev-card-title{display:flex;align-items:center;gap:10px;font-size:11px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#0A135B;margin:0 0 5px;}\n'
...
+ '.oev-table tbody td{padding:4px 10px;border-bottom:1px solid rgba(10,19,91,0.06);vertical-align:middle;}\n'
...
+ '.oev-body{display:grid;grid-template-columns:1.55fr 1fr;gap:12px;align-items:stretch;}\n'
...
+ '.oev-pill{display:flex;align-items:center;gap:10px;padding:5px 11px;border-radius:10px;background:#fff;border:1px solid #E8E5DF;box-shadow:0 1px 4px rgba(0,0,0,0.06);margin-bottom:4px;flex:1 1 0;min-height:0;}\n'
